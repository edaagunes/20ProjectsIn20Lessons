namespace SQLAllRelations
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.db14Project20DataSet = new SQLAllRelations.Db14Project20DataSet();
			this.teamsBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.teamsTableAdapter = new SQLAllRelations.Db14Project20DataSetTableAdapters.TeamsTableAdapter();
