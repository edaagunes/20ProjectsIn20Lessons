...
namespace MovieProject
{
	public partial class FrmMovie : Form
	{
		...
		private void btnMovieListWithCategory_Click(object sender, EventArgs e)
		{
			var values = context.Movies.Join(context.Categories, movie => movie.CategoryId, category => category.CategoryId, (movie, category) => new
			{
